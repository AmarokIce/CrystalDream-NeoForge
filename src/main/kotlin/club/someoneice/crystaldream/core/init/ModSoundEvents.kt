...
object ModSoundEvents {
    ...
    val GOBLINS_HAPPY by SOUNDS.register("goblins_happy", object: Supplier<SoundEvent> {
        override fun get() = SoundEvent.createVariableRangeEvent(createModPath("goblins_happy"))
    })
}
