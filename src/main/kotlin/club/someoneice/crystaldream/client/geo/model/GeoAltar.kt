...
class GeoAltar: GeoModel<TileAltar>() {
    ...
    override fun getTextureResource(animatable: TileAltar): ResourceLocation = createModPath("textures/geo/magic_altar.png")
    override fun getAnimationResource(animatable: TileAltar): ResourceLocation = createModPath("animations/magic_altar.animation.json")
}